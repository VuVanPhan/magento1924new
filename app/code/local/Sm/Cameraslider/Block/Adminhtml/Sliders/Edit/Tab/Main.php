...
-------------------------------------------------------------------------*/
class Sm_Cameraslider_Block_Adminhtml_Sliders_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareLayout()
    {
        ...
        if(Mage::app()->getRequest()->getActionName() == 'addSliders')
        {
            ...
            $head->addJs('sm/cameraslider/js/renderhelper.js');
            $head->addJs('sm/cameraslider/js/rendersliders.js');
            ...
            $head->addJs('sm/cameraslider/js_plugin/js/camera.js');
            $head->addItem('skin_css', 'sm/cameraslider/css/cameraslider.css');
            $head->addItem('skin_css', 'sm/cameraslider/css/jquery-ui-1.10.3.min.css');
            $head->addItem('skin_css', 'sm/cameraslider/css/font-awesome.css');
        }
    ...
    {
        return 'sm_cameraslider/sliders';
    }
    ...
    public function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend'    => "<i class='fa fa-cog'></i>".Mage::helper('sm_cameraslider')->__('General'),
            'class'     => 'collapsible'
        ));
        ...
        $fieldset->addField('sliders_title', 'text', array(
            'name'      => 'sliders_title',
            'label'     => Mage::helper('sm_cameraslider')->__('Title'),
            'title'     => Mage::helper('sm_cameraslider')->__('Title'),
        ...
        $fieldset->addField('status', 'select', array(
            'name'      => 'status',
            'label'     => Mage::helper('sm_cameraslider')->__('Status'),
            'title'     => Mage::helper('sm_cameraslider')->__('Status'),
            'values'    => $modelSliders->getStatusActiveNotActive(),
            'required'  => false,
        ));

        $fieldset2 = $form->addFieldset('layers_fieldset', array(
            'legend'    => "<i class='fa fa-tasks'></i>".Mage::helper('sm_cameraslider')->__('Sliders Image and Layers'),
            'class'     => 'collapsible'
        ));

        $bg = $fieldset2->addField('background_type', 'select', array(
            'name'      => 'background_type',
            'label'     => Mage::helper('sm_cameraslider')->__('Background Type'),
            'title'     => Mage::helper('sm_cameraslider')->__('Background Type'),
        ...
        $bg1 = $fieldset2->addField('data_src', 'text', array(
            'name'  => 'data_src',
            'label' => Mage::helper('sm_cameraslider')->__('Data Src Image'),
            'title' => Mage::helper('sm_cameraslider')->__('Data Src Image'),
            'onchange'  => 'CmrSl.updateContainer()',
            'note'  => Mage::helper('sm_cameraslider')->__('The URL of the image of the slide')
        ));
        $form->getElement('data_src')->setRenderer($this->getLayout()->createBlock('sm_cameraslider/adminhtml_widget_form_browsers', '', array(
            'element'   => $bg1
        )));
        ...
        $bg6 = $fieldset2->addField('sliders_bg_color', 'text', array(
            ...
            'label'     => Mage::helper('sm_cameraslider')->__('Background Color'),
            'title'     => Mage::helper('sm_cameraslider')->__('Background Color'),
        ...
        $fieldset2->addField('preview_width', 'text', array(
            ...
            'name'      => 'preview_width',
            'label'     => Mage::helper('sm_cameraslider')->__('Preview Width'),
            'title'     => Mage::helper('sm_cameraslider')->__('Preview Width'),
        ...
        $fieldset2->addField('preview_height', 'text', array(
            'class'     => 'validate-number',
            'name'      => 'preview_height',
            'label'     => Mage::helper('sm_cameraslider')->__('Preview Height'),
            'title'     => Mage::helper('sm_cameraslider')->__('Preview Height'),
            'onchange'  => 'CmrSl.collectContainer()',
        ...
        $fieldset2->addField('layers', 'text', array(
            'label' => Mage::helper('sm_cameraslider')->__('Layers')
        ));

        $form->getElement('layers')->setRenderer(
            $this->getLayout()->createBlock('sm_cameraslider/adminhtml_widget_form_layers')
        );
        ...
        $fieldset3 = $left->addFieldset('layer_params_fieldset', array(
            'legend'    => "<i class='fa fa-list-ul'></i>".Mage::helper('sm_cameraslider')->__('Layer General Parameters'),
            'class'     => 'collapsible'
        ));

        $fieldset3->addField('layer_width', 'text', array(
	        'class'     => 'validate-number',
            'label'     => Mage::helper('sm_cameraslider')->__('Width'),
            'title'     => Mage::helper('sm_cameraslider')->__('Width'),
        ...
        $fieldset3->addField('layer_height', 'text', array(
	        'class'     => 'validate-number',
            'label'     => Mage::helper('sm_cameraslider')->__('Height'),
            'title'     => Mage::helper('sm_cameraslider')->__('Height'),
            'require'   => true,
        ...
        $fieldset3->addField('layer_min_width', 'text', array(
	        'class'     => 'validate-number',
            'label'     => Mage::helper('sm_cameraslider')->__('Min Width'),
            'title'     => Mage::helper('sm_cameraslider')->__('Min Width'),
            'require'   => true,
        ...
        $fieldset3->addField('layer_min_height', 'text', array(
	        'class'     => 'validate-number',
            'label'     => Mage::helper('sm_cameraslider')->__('Min Height'),
            'title'     => Mage::helper('sm_cameraslider')->__('Min Height'),
            'require'   => true,
        ...
        $fieldset3->addField('layer_bg_color', 'text', array(
            'class'     => 'color {required:false}',
            'label'     => Mage::helper('sm_cameraslider')->__('Layer Background Color'),
            'title'     => Mage::helper('sm_cameraslider')->__('Layer Background Color'),
        ...
        $fieldset3->addField('layer_color', 'text', array(
            'class'     => 'color {required:false}',
            'label'     => Mage::helper('sm_cameraslider')->__('Layer Text Color'),
            'title'     => Mage::helper('sm_cameraslider')->__('Layer Text Color'),
        ...
        $fieldset3->addField('layer_text_align', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Text Align'),
            'title'     => Mage::helper('sm_cameraslider')->__('Text Align'),
            'values'    => $modelSliders->getOptsTextAlign(),
        ));

        $fieldset3->addField('layer_textBold', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Text Bold'),
            'title'     => Mage::helper('sm_cameraslider')->__('Text Bold'),
            'values'    => $modelSliders->getOptsTextBold(),
        ));

        $fieldset3->addField('layer_textItalic', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Text Italic'),
            'title'     => Mage::helper('sm_cameraslider')->__('Text Italic'),
            'values'    => $modelSliders->getOptsTextItalic(),
        ));

        $fieldset3->addField('layer_textUnderline', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Text Underline'),
            'title'     => Mage::helper('sm_cameraslider')->__('Text Underline'),
            'values'    => $modelSliders->getOptsTextUnderline(),
        ));

	    $fieldset3->addField('layer_textTransform', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Text Transform'),
            'title'     => Mage::helper('sm_cameraslider')->__('Text Transform'),
            'values'    => $modelSliders->getTextTransform(),
        ));

        $fieldset3->addField('layer_font_family', 'text', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Font Family'),
            'title'     => Mage::helper('sm_cameraslider')->__('Font Family'),
        ...
        $fieldset3->addField('layer_font_size', 'text', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Font Size'),
            'title'     => Mage::helper('sm_cameraslider')->__('Font Size'),
            'class'     => 'validate-number',
            'require'   => true,
        ...
        $fieldset3->addField('layer_top', 'text', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Top'),
            'title'     => Mage::helper('sm_cameraslider')->__('Top'),
            'class'     => 'validate-number',
            'require'   => true,
        ...
        $fieldset3->addField('layer_left', 'text', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Left'),
            'title'     => Mage::helper('sm_cameraslider')->__('Right'),
            'class'     => 'validate-number',
            'require'   => true,
            'note'      => "Only use type number, Ex : 50, 100, ..."
        ));
        ...
        $fieldset4 = $right->addFieldset('layer_time_fieldset', array(
            'legend'    => "<i class='fa fa-sort-numeric-asc'></i>".Mage::helper('sm_cameraslider')->__('Layers Timing & Sorting')
        ));

        $fieldset4->setHeaderBar(
            $this->getLayout()->createBlock('adminhtml/widget_button', '', array(
                'label'     => "<i class='fa fa-list'></i>".Mage::helper('sm_cameraslider')->__('By Depth'),
                'title'     => Mage::helper('sm_cameraslider')->__('By Depth'),
                'type'      => 'button',
            ...
            $this->getLayout()->createBlock('adminhtml/widget_button', '', array(
                ...
                'title'		=> Mage::helper('sm_cameraslider')->__('Hide All Layer'),
                'type'		=> 'button',
        ...
        $form->getElement('list_sorting')->setRenderer(
            $this->getLayout()->createBlock('sm_cameraslider/adminhtml_widget_form_sorting')
        );

        $fieldset5 = $form->addFieldset('layer_animate_fieldset', array(
            'legend'    => "<i class='fa fa-outdent'></i>".Mage::helper('sm_cameraslider')->__('Layer Animation '),
            'class'     => 'collapsible'
        ));

        $fieldset5->addField('layer_animation_preview', 'text', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Preview Transition'),
            'note'      => Mage::helper('sm_cameraslider')->__('Preview Transition (Start & End Time is ignored during demo)')
        ));

        $form->getElement('layer_animation_preview')->setRenderer(
            $this->getLayout()->createBlock('sm_cameraslider/adminhtml_widget_form_animation')
        );

        $fieldset5->addField('layer_class', 'text', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Layer Class'),
            'title'     => Mage::helper('sm_cameraslider')->__('Layer Class'),
            'require'   => false,
            'note'      => 'Class not contain space. Ex: class_1, class_2, ...'
        ));

        $fieldset5->addField('layer_time_transitions', 'text', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Time Transitions Layer'),
            'title'     => Mage::helper('sm_cameraslider')->__('Time Transitions Layer'),
            'require'   => false,
            'onchange'  => 'CmrSl.updateContainer()',
        ...
        $fieldset5->addField('layer_time_delay_transitions', 'text', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Time Delay Transitions Layer'),
            'title'     => Mage::helper('sm_cameraslider')->__('Time Delay Transitions Layer'),
            'require'   => false,
            'onchange'  => 'CmrSl.updateContainer()',
            'note'      => 'Time delay load of a layer in milliseconds'
        ));
	    ...
	    $fieldset5->addField('layer_alt_image', 'text', array(
		    'label'     => Mage::helper('sm_cameraslider')->__('Alt Image'),
		    'title'     => Mage::helper('sm_cameraslider')->__('Alt Image'),
		    'onchange'  => 'CmrSl.updateContainer()',
		    'require'   => false,
	    ));
	    ...
	    $fieldset5->addField('layer_title_image_link', 'text', array(
		    ...
		    'label'     => Mage::helper('sm_cameraslider')->__('Title Image Link'),
		    'title'     => Mage::helper('sm_cameraslider')->__('Title Image Link'),
		    'onchange'  => 'CmrSl.updateContainer()',
	    ...
	    $fieldset5->addField('layer_target_link', 'select', array(
		    ...
		    'label'     => Mage::helper('sm_cameraslider')->__('Target Image Link'),
		    'title'     => Mage::helper('sm_cameraslider')->__('Target Image Link'),
	    ...
	    $fieldset5->addField('layer_link', 'text', array(
		    'name'      => 'layer_link',
		    'label'     => Mage::helper('sm_cameraslider')->__('Http Image Link'),
		    'title'     => Mage::helper('sm_cameraslider')->__('Http Image Link'),
		    'onchange'  => 'CmrSl.updateContainer()',
        ...
        $fieldset5->addField('layer_text', 'textarea', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Text / Html'),
            'title'     => Mage::helper('sm_cameraslider')->__('Text / Html'),
            'onchange'  => 'CmrSl.updateContainer()'
        ));

        $fieldset5->addField('layer_data_fxin', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Data Sliders Transitions In'),
            'title'     => Mage::helper('sm_cameraslider')->__('Data Sliders Transitions In'),
        ...
        $fieldset5->addField('layer_data_fxout', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Data Sliders Transitions Out'),
            'title'     => Mage::helper('sm_cameraslider')->__('Data Sliders Transitions Out'),
        ...
        $fieldset5->addField('layer_data_fadein', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Data Fade In'),
            'title'     => Mage::helper('sm_cameraslider')->__('Data Fade In'),
        ...
        $fieldset5->addField('layer_data_fadeout', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Data Fade Out'),
            'title'     => Mage::helper('sm_cameraslider')->__('Data Fade Out'),
            'values'    => $modelSliders->getTrueFalse(),
            'onchange'  => 'CmrSl.updateContainer()',
        ...
        $fieldset5->addField('layer_data_easein', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Data Easing In'),
            'title'     => Mage::helper('sm_cameraslider')->__('Data Easing In'),
        ...
        $fieldset5->addField('layer_data_easeout', 'select', array(
            'label'     => Mage::helper('sm_cameraslider')->__('Data Easing Out'),
            'title'     => Mage::helper('sm_cameraslider')->__('Data Easing Out'),
            'values'    => $modelSliders->getDataEasing(),
            'onchange'  => 'CmrSl.updateContainer()',
            'note'      => 'The easing effect for only layer',
            'require'   => false
