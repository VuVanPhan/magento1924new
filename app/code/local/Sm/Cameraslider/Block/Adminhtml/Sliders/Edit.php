<?php
	...
	* 
	*/
	class Sm_Cameraslider_Block_Adminhtml_Sliders_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
	{
        ...
        public function _prepareLayout()
        {
            ...
            $backUrl = $this->getUrl('*/*/edit', array(
                'id'        => $slide->getId(),
                'activeTab' => 'form_slide' // name tab lấy ở trong Sm_Cameraslider_Block_Adminhtml_Cameraslider_Edit_Tabs tab Sliders
            ));
            ...
            $this->_addButton('sac', array(
                'label'     => Mage::helper('sm_cameraslider')->__('Save And Continue Edit'),
                'class'     => 'save',
        ...
        */
        ...
        {
            $modelSliders = Mage::registry('sliders');//helper('sm_cameraslider')->getCamerasliderItemInstance();
//            $params = Mage::helper('core')->jsonDecode($modelSliders['params']);
            if($modelSliders->getId())
            {
                return "<i class='fa fa-qrcode'></i>".Mage::helper('sm_cameraslider')->__("%s", $this->escapeHtml($modelSliders->getData('sliders_title')));
            }else{
                return "<i class='fa fa-plus-circle'></i>".Mage::helper('sm_cameraslider')->__('Add New Sliders');
            }
        }
	}
?>