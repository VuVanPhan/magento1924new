 ...
 * Time: 9:17
 */
class Sm_Cameraslider_Block_Adminhtml_Widget_Form_Layers extends Mage_Adminhtml_Block_Widget implements Varien_Data_Form_Element_Renderer_Interface
{
    protected $_element;
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('sm/cameraslider/widget/form/layers.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        $addLayerBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'addLayerBtn', array(
            'type'      => 'button',
            'label'     => "<i class='fa fa-file-text'></i>".Mage::helper('sm_cameraslider')->__('Add Layer Text'),
            'title'     => Mage::helper('sm_cameraslider')->__('Add Layer Text'),
        ...
        $addLayerBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'addLayerImageBtn', array(
            'label'     => "<i class='fa fa-picture-o'></i>".Mage::helper('sm_cameraslider')->__('Add Layer Image'),
            'title'     => Mage::helper('sm_cameraslider')->__('Add Layer Image'),
            'type'      => 'button',
            ...
            )), Mage::helper('sm_cameraslider')->__('Add Image')),
            'id'        => 'addLayerImageBtn'
        ));
        ...
        $addLayerBtn = $this->getLayout()->createBlock( 'adminhtml/widget_button', 'addLayerVideoBtn', array(
            'type' => 'button',
            'title' => Mage::helper( 'sm_cameraslider' )->__( 'Add Layer Video' ),
            'label' => "<i class='fa fa-video-camera'></i>" . Mage::helper( 'sm_cameraslider' )->__( 'Add Layer Video' ),
            'onclick' => sprintf( '_MediabrowserUtility.openDialog(\'%s\', \'addLayerVideoWindow\', null, 700, \'%s\')', Mage::getSingleton( 'adminhtml/url' )->getUrl( 'adminhtml/adminhtml_cameraslider/video' ), Mage::helper( 'sm_cameraslider' )->__( 'Add Video' ) ),
	        'id'        => 'addLayerVideoBtn'
        ) );
        ...
        $addLayerBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'dupLayerBtn', array(
            'label'     => "<i class='fa fa-files-o'></i>".Mage::helper('sm_cameraslider')->__('Duplicate Layer'),
            'title'     => Mage::helper('sm_cameraslider')->__('Duplicate Layer'),
        ...
        $addLayerBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'editLayerBtn', array(
            'title'     => Mage::helper('sm_cameraslider')->__('Edit Layer'),
            'label'     => "<i class='fa fa-pencil-square-o'></i>".Mage::helper('sm_cameraslider')->__('Edit Layer'),
        ...
        $addLayerBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'deleteLayerBtn', array(
            'label'     => "<i class='fa fa-times-circle'></i>".Mage::helper('sm_cameraslider')->__('Delete Layer'),
            'title'     => Mage::helper('sm_cameraslider')->__('Delete Layer'),
            'type'      => 'button',
        ...
        $addLayerBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'deleteAllLayerBtn', array(
            'label'     => "<i class='fa fa-times-circle'></i>".Mage::helper('sm_cameraslider')->__('Delete All Layer'),
            'title'     => Mage::helper('sm_cameraslider')->__('Delete All Layer'),
            'type'      => 'button',
	...
	{
		return Mage::getSingleton( 'adminhtml/url' )->getUrl( 'adminhtml/adminhtml_cameraslider/video' );
	}
}