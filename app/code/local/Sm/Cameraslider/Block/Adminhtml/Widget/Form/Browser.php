 ...
 * Time: 14:38
 */
class Sm_Cameraslider_Block_Adminhtml_Widget_Form_Browser extends Sm_Cameraslider_Block_Adminhtml_Widget_Form_Browsers
{
    protected function _prepareLayout()
    {
        ...
        $browsersBtn = $this->getLayout()->createBlock( 'adminhtml/widget_button', 'button', array(
            ...
            'title' => Mage::helper( 'sm_cameraslider' )->__( 'Click to browser media' ),
            'type' => 'button',
            ...
            ) ), Mage::helper( 'sm_cameraslider' )->__( 'Select Video' ) )
        ) );
