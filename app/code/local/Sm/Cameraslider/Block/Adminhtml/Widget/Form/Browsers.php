 ...
 * Time: 15:03
 */
class Sm_Cameraslider_Block_Adminhtml_Widget_Form_Browsers extends Mage_Adminhtml_Block_Widget implements Varien_Data_Form_Element_Renderer_Interface{
    protected $_element;

    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('sm/cameraslider/widget/form/browser.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $browsersBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button', array(
            ...
            'title'     => Mage::helper('sm_cameraslider')->__('Click to browsers'),
            'type'      => 'button',
        ...
        $clearBtn = $this->getLayout()->createBlock( 'adminhtml/widget_button', 'button', array(
            ...
            'title' => Mage::helper( 'sm_cameraslider' )->__( 'Click to clear' ),
            'type' => 'button',
