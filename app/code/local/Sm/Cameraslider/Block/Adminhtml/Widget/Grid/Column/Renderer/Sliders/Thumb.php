 ...
 * Time: 9:03
 */
class Sm_Cameraslider_Block_Adminhtml_Widget_Grid_Column_Renderer_Sliders_Thumb extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function _getValue(Varien_Object $row)
    {
        ...
        {
            return sprintf('<img src="%s" height="200" width="500" />', strpos($params['data_thumb'], 'http') == 0 ? Mage::getBaseUrl('media').$params['data_thumb'] : $this->getSkinUrl('sm/cameraslider/images/nophoto.jpg'));
        }
        elseif(isset($params['background_type']) && ($params['background_type']))
        {
            switch($params['background_type'])
            {
                case 'image' :
                    ...
                    {
                        return sprintf('<img src="%s" height="200" width="500" style="margin: 4px auto;" />', strpos($params['data_src'], 'http') == 0 ? Mage::getBaseUrl('media').$params['data_src'] : $this->getSkinUrl('sm/cameraslider/images/nophoto.jpg'));
                    }else{
                        return sprintf('<img src="%s" height="200" width="500" style="margin: 4px auto;" />', $this->getSkinUrl('sm/cameraslider/images/nophoto.jpg'));
                    }
                    break;
                case 'color' :
            ...
            return sprintf('<img src="%s" height="200" width="500" />', $this->getSkinUrl('sm/cameraslider/images/nophoto.jpg'));
        }
    }
}