<?php
    class Sm_Cameraslider_Block_Adminhtml_Cameraslider_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
    {
        ...
        public function _prepareForm()
        {
            ...
            $form->setHtmlIdPrefix('cameraslider_general_');

            $fieldset = $form->addFieldset('base_fieldset', array(
                'legend'    => "<i class='fa fa-gears'></i>".Mage::helper('sm_cameraslider')->__('General Options'),
                'class'     => 'collapsible'
            ));
            ...
            $fieldset->addField('name_slide', 'text', array(
                'name'      => 'name_slide',
                'label'     => Mage::helper('sm_cameraslider')->__('Name Slide'),
                'title'     => Mage::helper('sm_cameraslider')->__('Name Slide'),
            ...
            $fieldset->addField('slide_width', 'text', array(
                ...
                'name'      => 'slide_width',
                'label'     => Mage::helper('sm_cameraslider')->__('Slide Width'),
                'title'     => Mage::helper('sm_cameraslider')->__('Slide Width'),
                'require'   => true,
            ...
            $fieldset->addField('slide_height', 'text', array(
                'class'     => 'required-entry validate-number',
                'name'      => 'slide_height',
                'label'     => Mage::helper('sm_cameraslider')->__('Slide Height'),
                'title'     => Mage::helper('sm_cameraslider')->__('Slide Height'),
                'require'   => true,
            ...
            $fieldset->addField('time_load', 'text', array(
                ...
                'name'      => 'time_load',
                'label'     => Mage::helper('sm_cameraslider')->__('Time Load'),
                'title'     => Mage::helper('sm_cameraslider')->__('Time Load'),
                'require'   => true,
                'note'      => Mage::helper('sm_cameraslider')->__('Milliseconds between the end of the sliding effect and start of the next one'),
            ...
            $fieldset->addField('trans_period', 'text', array(
                'class'     => 'validate-number required-entry',
                'name'      => 'trans_period',
                'label'     => Mage::helper('sm_cameraslider')->__('Translate Period'),
                'title'     => Mage::helper('sm_cameraslider')->__('Translate Period'),
                'require'   => true,
                'value'     => (int)$model->getData('time_load') ? (int)$model->getData('time_load') : 1500,
                'note'      => Mage::helper('sm_cameraslider')->__('Length of the sliding effect in milliseconds'),
                'disable'   => $isElementDisabled
            ));

            $fieldset->addField('play_pause', 'select', array(
                'name'      => 'play_pause',
                'label'     => Mage::helper('sm_cameraslider')->__('Play Pause'),
                'title'     => Mage::helper('sm_cameraslider')->__('Play Pause'),
                'require'   => false,
                'type'      => 'options',
            ...
            $fieldset->addField('auto_advance', 'select', array(
                'name'      => 'auto_advance',
                'label'     => Mage::helper('sm_cameraslider')->__('Auto Advance'),
                'title'     => Mage::helper('sm_cameraslider')->__('Auto Advance'),
                'require'   => false,
                'type'      => 'options',
                'options'   => $model->getTrueFalse(),
            ...
            $fieldset->addField('prev_next', 'select', array(
                'name'      => 'prev_next',
                'label'     => Mage::helper('sm_cameraslider')->__('Prev Next'),
                'title'     => Mage::helper('sm_cameraslider')->__('Prev Next'),
                'require'   => false,
                'type'      => 'options',
                'options'   => $model->getTrueFalse(),
            ...
            $fieldset->addField('pagination', 'select', array(
                'name'      => 'pagination',
                'label'     => Mage::helper('sm_cameraslider')->__('Pagination'),
                'title'     => Mage::helper('sm_cameraslider')->__('Pagination'),
                'require'   => false,
            ...
            Mage::dispatchEvent('adminhtml_cameraslider_edit_tab_slide_prepare_form', array('form' => $form));
            /*
