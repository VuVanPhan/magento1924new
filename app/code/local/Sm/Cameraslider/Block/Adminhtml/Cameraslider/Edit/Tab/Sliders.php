<?php
    class Sm_Cameraslider_Block_Adminhtml_Cameraslider_Edit_Tab_Sliders extends Mage_Adminhtml_Block_Widget_Grid
    {
        ...
        {
            $this->getLayout()->getBlock('head')->addJs('sm/cameraslider/js/renderhelper.js');
            ...
            if($sliders && $sliders->getId())
            {
                ...
                $this->setChild('addSlidesButton', $this->getLayout()->createBlock( 'adminhtml/widget_button' )->setData( array(
                    'label' => Mage::helper( 'sm_cameraslider' )->__( 'Add Slide' ),
...
//            $collection = Mage::getModel($this->_getCollectionSlidersClass())->getCollection()->addFieldToFilter('slide_id', $this->getIdSliders());
        ...
        public function _prepareColumns()
        {
            ...
            $this->addColumn('sliders_title', array(
                'header'    => Mage::helper('sm_cameraslider')->__('Title'),
                'align'     => 'center',
                'width'     => '40%',
                'filter'    => false,
                'sortable'  => false,
                'renderer'  => 'sm_cameraslider/adminhtml_widget_grid_column_renderer_sliders_title'
            ));

            $this->addColumn('sliders_thumb', array(
                'header'    => Mage::helper('sm_cameraslider')->__('Thumb'),
                'align'     => 'center',
                'filter'    => false,
                'sortable'  => false,
                'renderer'  => 'sm_cameraslider/adminhtml_widget_grid_column_renderer_sliders_thumb'
            ));

            $this->addColumn('sliders_priority', array(
                'header'    => Mage::helper('sm_cameraslider')->__('Priority'),
                'align'     => 'center',
                'width'     => '160',
                'renderer'  => 'sm_cameraslider/adminhtml_widget_grid_column_renderer_sliders_priority'
            ));
...
//                'width'		=> '100px',
            ...
            $this->addColumn('delete', array(
                'header'	=> Mage::helper('sm_cameraslider')->__('Delete'),
//                'width'		=> '100px',
                'align'     => 'center',
                'type'		=> 'action',
                'getter'	=> 'getId',
                'actions'	=> array(
                    array(
                        'field'		=> 'id',
                        'caption' 	=> Mage::helper('sm_cameraslider')->__('Delete'),
