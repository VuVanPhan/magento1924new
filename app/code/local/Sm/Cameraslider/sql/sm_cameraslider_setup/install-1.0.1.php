...
/*
 * @var $installer Sm_Cameraslider_Model_Resource_Setup
 * */
...
$table = $installer->getConnection()
    ->newTable($installer->getTable('sm_cameraslider/slide'))
 ...
 * */
$table = $installer->getConnection()
    ->newTable($installer->getTable('sm_cameraslider/sliders'))
    ...
    ->addColumn('priority', Varien_Db_Ddl_Table::TYPE_INTEGER, 0, array(
        'unsigned'  => true,
        'nullable'  => false,
    ), 'Priority')
    ->addColumn('params', Varien_Db_Ddl_Table::TYPE_TEXT, null, array(
