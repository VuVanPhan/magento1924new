...
CameraSlide.prototype = {
	...
	onYoutubeCallback: function(a) {
		...
		c.title = b.title;
		c.author = b.channelTitle;
		c.link = 'https://www.youtube.com/watch?v='+c.id;
		var d = b.thumbnails;
		c.thumb_small = {
			url: d.default.url,
		...
		c.thumb_medium = {
			url: d.medium.url,
			width: d.medium.width,
			height: d.medium.height
		};
		c.thumb_big = {
			url: d.high.url,
			width: d.high.width,
			height: d.high.height
		};
		this.videoData = c;
	...
	searchVideo: function() {
		...
		if (c) {
			...
			switch (a) {
				case "youtube":
					jQuery.ajax({
						url: "https://www.googleapis.com/youtube/v3/videos?id=" + c + "&key=AIzaSyCk0gN5ogU7T3OiUU1ru49ksedrCTh7T58&part=snippet,contentDetails,statistics,status&callback=CmrSl.onYoutubeCallback",
						type:'GET',
						success: function(data){
							var f = "https://www.googleapis.com/youtube/v3/videos?id=" + c + "&key=AIzaSyCk0gN5ogU7T3OiUU1ru49ksedrCTh7T58&part=snippet,contentDetails,statistics,status&callback=CmrSl.onYoutubeCallback";
							e.src = f;
							d.appendChild(e);
						},
						error: function(data){
