...
tinymce.util.Quirks = function(a) {
    ...
    function s() {
        function N(Q) {
            ...
            P.appendChild(R);
            return n.serializer.serialize(P, {
                format: "html"
            })
        }
    ...
    function x() {
        var P, O, af, N, aa, ad, ab, ae, Q, R, ac, Y, X, Z = document,
            V = a.getDoc();
...
(function(b) {
    ...
    b.html.DomParser = function(g, h) {
        ...
        f.parse = function(v, m) {
            ...
            n = new b.html.SaxParser({
                ...
                text: function(P, l) {
                    ...
                    if (!L) {
                        ...
                        console.log(P);
                        console.log(B);
                        console.log(B.lastChild && o[B.lastChild.name]);
            ...
            // console.log(n);
            // console.log(new a(m.context || g.root_name, 11));
            // B = new b.html.Node(m.context || g.root_name, 11);
            B = new a(m.context || g.root_name, 11);
            console.log(B);
            J = B;
            n.parse(v);
            if (z && M.length) {
...
(function(k) {
    ...
    k.create("tinymce.Editor", {
        ...
        setContent: function(r, p) {
            ...
            if (p.format !== "raw") {
                // console.log(r)
                // console.log(o.parser);
                // console.log(o.parser.parse(r));
